...
Project Overview
A healthcare organization is experiencing high attrition rates and varying levels of employee satisfaction across departments. This project analyzes employee data to identify the key factors driving turnover and provides actionable recommendations to improve retention.

 Business Problem
With 199 out of 1,676 employees leaving (11.87% attrition rate), the organization needs to understand what's causing departures and where to focus retention efforts for maximum impact.
...
Author
Jai Varanasi | [InsightArc Analytics] https://www.linkedin.com/in/s-jai-varanasi-0b651037b/
