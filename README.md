...
**[View the Tableau Dashboard](https://public.tableau.com/views/WatsonHealthcareEmployeeAttritionTrends/AttritionDashboard?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link)** | | **[View the Presentation](presentation/Watson_Healthcare_Attrition_Presentation.pptx)**
